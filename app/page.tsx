...
export default function Home() {
  return (
    <div className="min-h-screen text-white font-sans selection:bg-yellow-400 selection:text-purple-900 flex flex-col justify-between"
      style={{ background: 'linear-gradient(160deg, #1A0A2E 0%, #2D1250 50%, #1A0A2E 100%)' }}>

      {/* Top Gold Stripe */}
      <div className="h-2 w-full" style={{ background: 'linear-gradient(90deg, #5B2D8E, #F5C518, #5B2D8E)' }}></div>

      {/* Header / Nav */}
      <nav className="max-w-7xl mx-auto px-6 py-5 w-full flex items-center justify-between border-b border-purple-800/30">
        ...
        <Link
          ...
          style={{
            ...
            color: '#3B0F6F',
            border: '2px solid rgba(91,45,142,0.5)',
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 text-center flex flex-col items-center justify-center flex-1">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border text-xs font-bold uppercase tracking-widest mb-5"
          style={{ background: 'rgba(91,45,142,0.25)', borderColor: 'rgba(245,197,24,0.4)', color: '#F5C518' }}>
        ...
        <h1 className="text-4xl sm:text-5xl font-black uppercase tracking-tight leading-tight mb-4">
          ...
          <br />
          <span style={{
            background: 'linear-gradient(90deg, #A855F7, #F5C518, #FFD700)',
        ...
        <p className="text-base sm:text-lg max-w-2xl mx-auto font-normal leading-relaxed mb-10"
          style={{ color: 'rgba(216,180,254,0.7)' }}>
          Buat kartu panitia 17-an resmi <strong style={{ color: '#F5C518' }}>Cimanggu Wates</strong> berukuran standar KTP/ID Card.
          Kustomisasi foto, tema Ungu & Emas elegan, dan export kualitas cetak HD.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-16 text-left w-full">
          <div className="rounded-2xl p-5" style={{ background: 'rgba(91,45,142,0.2)', border: '1px solid rgba(91,45,142,0.5)' }}>
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3"
              style={{ background: 'rgba(91,45,142,0.4)', border: '1px solid rgba(168,85,247,0.4)' }}>
              <ShieldCheck className="w-5 h-5" style={{ color: '#F5C518' }} />
            </div>
            <h3 className="font-bold text-white text-sm mb-1">Rasio Pas Ukuran KTP</h3>
            <p className="text-xs" style={{ color: 'rgba(216,180,254,0.6)' }}>
          ...
          <div className="rounded-2xl p-5" style={{ background: 'rgba(91,45,142,0.2)', border: '1px solid rgba(91,45,142,0.5)' }}>
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3"
              style={{ background: 'rgba(91,45,142,0.4)', border: '1px solid rgba(168,85,247,0.4)' }}>
              <ImageIcon className="w-5 h-5" style={{ color: '#F5C518' }} />
            </div>
            <h3 className="font-bold text-white text-sm mb-1">Kustomisasi Foto Interaktif</h3>
            <p className="text-xs" style={{ color: 'rgba(216,180,254,0.6)' }}>
              Upload foto wajah panitia, zoom in/out dan geser posisi secara interaktif langsung di browser.
            </p>
          </div>
          ...
          <div className="rounded-2xl p-5" style={{ background: 'rgba(91,45,142,0.2)', border: '1px solid rgba(91,45,142,0.5)' }}>
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3"
              style={{ background: 'rgba(91,45,142,0.4)', border: '1px solid rgba(168,85,247,0.4)' }}>
              <Download className="w-5 h-5" style={{ color: '#F5C518' }} />
            </div>
            <h3 className="font-bold text-white text-sm mb-1">Export HD & Supabase Ready</h3>
            <p className="text-xs" style={{ color: 'rgba(216,180,254,0.6)' }}>
              Unduh PNG resolusi tinggi siap cetak dan simpan riwayat kartu ke database Supabase.
            </p>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer className="border-t py-5 text-center text-xs" style={{ borderColor: 'rgba(91,45,142,0.4)', color: 'rgba(216,180,254,0.4)' }}>
        <p>© 2026 <span style={{ color: '#F5C518', fontWeight: 700 }}>IPPCW REBORN</span> – Cimanggu Wates. Dirgahayu Republik Indonesia Ke-81. 🇮🇩</p>
      </footer>

      {/* Bottom Gold Stripe */}
      <div className="h-1.5 w-full" style={{ background: 'linear-gradient(90deg, #5B2D8E, #F5C518, #5B2D8E)' }}></div>
    </div>
  );
}
